...
.method public static d(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILrc/b;)V
    .locals 8
    ...
    invoke-direct/range {v0 .. v6}, Ltc/b;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILrc/b;)V
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {v1, p0}, Luc/f;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v1}, Luc/f;->g()I

    move-result v0

    invoke-static {p0}, Luc/a;->c(Ljava/io/Closeable;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static i(Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)Landroid/graphics/Bitmap;
    .locals 7

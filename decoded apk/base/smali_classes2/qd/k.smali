...
.method public static final a(Ljava/io/File;)[B
    ...
    invoke-direct {v6, v9}, Lqd/e;-><init>(I)V

    invoke-virtual {v6, v5}, Ljava/io/ByteArrayOutputStream;->write(I)V

    const/4 v5, 0x2

    invoke-static {v0, v6, v3, v5, v8}, Lqd/b;->b(Ljava/io/InputStream;Ljava/io/OutputStream;IILjava/lang/Object;)J
    ...
    invoke-static {p0, v2, v1, v3, v4}, Lhd/i;->c([B[BIII)[B
    ...
    :goto_1
    invoke-static {v0, v8}, Lqd/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, p0}, Lqd/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V

...
.method private dispatchMessage(Landroid/content/Intent;)V
    ...
    invoke-direct {v3, p0, v1, v2}, Lg9/d;-><init>(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/util/concurrent/ExecutorService;)V

    :try_start_0
    invoke-virtual {v3}, Lg9/d;->a()Z
...
.method private getRpc(Landroid/content/Context;)Ld6/d;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->rpc:Ld6/d;
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->rpc:Ld6/d;

    :cond_0
    iget-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->rpc:Ld6/d;
...
.method private handleMessageIntent(Landroid/content/Intent;)V
    ...
    :cond_0
    invoke-direct {p0, p0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->getRpc(Landroid/content/Context;)Ld6/d;

    move-result-object v0

    new-instance v1, Ld6/a;

    invoke-direct {v1, p1}, Ld6/a;-><init>(Landroid/content/Intent;)V

    invoke-virtual {v0, v1}, Ld6/d;->a(Ld6/a;)Lcom/google/android/gms/tasks/Task;
...
.method private passMessageIntentToSdk(Landroid/content/Intent;)V
    ...
    invoke-direct {v1, p1}, Lg9/o0;-><init>(Ljava/lang/String;)V
...
.method public getStartCommandIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {p1}, Lg9/p0;->c()Landroid/content/Intent;
...
.method public setRpcForTesting(Ld6/d;)V
    .locals 0

    iput-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->rpc:Ld6/d;

...
.method public b(Lp5/a0;)Z
    ...
    invoke-virtual {v0, p1}, Ls3/m1$b;->h0(I)Ls3/m1$b;
    ...
    invoke-direct {p1, v0}, Lb4/e$a;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v1}, Ls3/m1$b;->J(I)Ls3/m1$b;

    move-result-object p1

    const/16 v0, 0x1f40

    invoke-virtual {p1, v0}, Ls3/m1$b;->h0(I)Ls3/m1$b;
...
.method public c(Lp5/a0;J)Z
    ...
    invoke-interface {v0, p1, v7}, Lx3/b0;->e(Lp5/a0;I)V
    ...
    invoke-virtual {p1, p3, v2, p2}, Lp5/a0;->l([BII)V

    invoke-static {p3}, Lu3/a;->f([B)Lu3/a$b;
    ...
    iget-object v0, p1, Lu3/a$b;->c:Ljava/lang/String;

    invoke-virtual {p2, v0}, Ls3/m1$b;->K(Ljava/lang/String;)Ls3/m1$b;

    move-result-object p2

    iget v0, p1, Lu3/a$b;->b:I

    invoke-virtual {p2, v0}, Ls3/m1$b;->J(I)Ls3/m1$b;

    move-result-object p2

    iget p1, p1, Lu3/a$b;->a:I

    invoke-virtual {p2, p1}, Ls3/m1$b;->h0(I)Ls3/m1$b;
    ...
    invoke-virtual {p1, p2}, Ls3/m1$b;->V(Ljava/util/List;)Ls3/m1$b;
    ...
    iget-object p2, p0, Lb4/e;->a:Lx3/b0;
    ...
    invoke-interface {v0, p1, v9}, Lx3/b0;->e(Lp5/a0;I)V

    iget-object v5, p0, Lb4/e;->a:Lx3/b0;

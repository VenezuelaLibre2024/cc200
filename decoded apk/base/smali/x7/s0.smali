...
.method public static synthetic a(Lcom/google/android/recaptcha/RecaptchaAction;Lcom/google/firebase/auth/FirebaseAuth;Ljava/lang/String;Lcom/google/android/gms/tasks/Continuation;Lcom/google/android/gms/tasks/Task;)Lcom/google/android/gms/tasks/Task;
    ...
    :cond_1
    invoke-virtual {p1}, Lcom/google/firebase/auth/FirebaseAuth;->p0()Lx7/b1;

    move-result-object p4

    if-nez p4, :cond_2

    new-instance p4, Lx7/b1;

    invoke-virtual {p1}, Lcom/google/firebase/auth/FirebaseAuth;->i()Ln7/g;

    move-result-object v0

    invoke-direct {p4, v0, p1}, Lx7/b1;-><init>(Ln7/g;Lcom/google/firebase/auth/FirebaseAuth;)V

    invoke-virtual {p1, p4}, Lcom/google/firebase/auth/FirebaseAuth;->k0(Lx7/b1;)V
    ...
    invoke-static {p1, p0, p2, p3}, Lx7/s0;->d(Lx7/b1;Lcom/google/android/recaptcha/RecaptchaAction;Ljava/lang/String;Lcom/google/android/gms/tasks/Continuation;)Lcom/google/android/gms/tasks/Task;
...
.method public static d(Lx7/b1;Lcom/google/android/recaptcha/RecaptchaAction;Ljava/lang/String;Lcom/google/android/gms/tasks/Continuation;)Lcom/google/android/gms/tasks/Task;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p0, p2, v0, p1}, Lx7/b1;->b(Ljava/lang/String;Ljava/lang/Boolean;Lcom/google/android/recaptcha/RecaptchaAction;)Lcom/google/android/gms/tasks/Task;

    move-result-object v0

    new-instance v1, Lx7/x0;

    invoke-direct {v1, p2, p0, p1, p3}, Lx7/x0;-><init>(Ljava/lang/String;Lx7/b1;Lcom/google/android/recaptcha/RecaptchaAction;Lcom/google/android/gms/tasks/Continuation;)V
...
.method public final b(Lcom/google/firebase/auth/FirebaseAuth;Ljava/lang/String;Lcom/google/android/recaptcha/RecaptchaAction;Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v0, p0}, Lx7/u0;-><init>(Lx7/s0;)V
    ...
    invoke-virtual {v1, p4}, Lx7/b1;->d(Ljava/lang/String;)Z

    move-result p4

    if-eqz p4, :cond_0

    invoke-static {v1, p3, p2, v0}, Lx7/s0;->d(Lx7/b1;Lcom/google/android/recaptcha/RecaptchaAction;Ljava/lang/String;Lcom/google/android/gms/tasks/Continuation;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {p0, p4}, Lx7/s0;->c(Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;

    move-result-object p4

    new-instance v1, Lx7/v0;

    invoke-direct {v1, p3, p1, p2, v0}, Lx7/v0;-><init>(Lcom/google/android/recaptcha/RecaptchaAction;Lcom/google/firebase/auth/FirebaseAuth;Ljava/lang/String;Lcom/google/android/gms/tasks/Continuation;)V

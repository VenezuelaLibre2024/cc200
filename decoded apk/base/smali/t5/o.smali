...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lt5/o;->a:[Ljava/lang/String;

    const-string v0, "androidPackageName"

    sput-object v0, Lt5/o;->b:Ljava/lang/String;
    ...
    sput-object v0, Lt5/o;->c:Landroid/content/ComponentName;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, v0, v1}, Lt5/o;->g(Landroid/content/Context;Ljava/lang/String;J)V
...
.method public static b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, v0}, Lt5/o;->c(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
...
.method public static c(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lt5/o;->p(Landroid/accounts/Account;)V
    ...
    invoke-static/range {v0 .. v6}, Lt5/o;->d(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;JLjava/util/concurrent/Executor;)Lcom/google/android/gms/auth/TokenData;
...
.method public static d(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;JLjava/util/concurrent/Executor;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p4}, Lh6/s;->k(Ljava/lang/String;)V

    const-string p4, "Scope cannot be empty or null."

    invoke-static {p2, p4}, Lh6/s;->g(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;

    invoke-static {p1}, Lt5/o;->p(Landroid/accounts/Account;)V

    const p4, 0x802c80

    invoke-static {p0, p4}, Lt5/o;->l(Landroid/content/Context;I)V
    ...
    :goto_0
    invoke-static {p0, p3}, Lt5/o;->n(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, Lt5/o;->q(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p4, p5}, Lt5/o;->j(Lcom/google/android/gms/tasks/Task;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p4

    check-cast p4, Landroid/os/Bundle;

    invoke-static {p4}, Lt5/o;->k(Ljava/lang/Object;)Ljava/lang/Object;

    const-string p6, "getTokenWithDetails"

    invoke-static {p0, p6, p4}, Lt5/o;->h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p4, p5}, Lt5/o;->m(Lf6/b;Ljava/lang/String;)V

    :cond_1
    new-instance v2, Lt5/l;

    invoke-direct {v2, p1, p2, p3, p0}, Lt5/l;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/Context;)V

    sget-object v1, Lt5/o;->c:Landroid/content/ComponentName;
    ...
    invoke-static/range {v0 .. v5}, Lt5/o;->i(Landroid/content/Context;Landroid/content/ComponentName;Lt5/n;JLjava/util/concurrent/Executor;)Ljava/lang/Object;
...
.method public static synthetic e(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/Context;Landroid/os/IBinder;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p3, p1, p0}, Lt5/o;->h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
...
.method public static bridge synthetic f(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lt5/o;->k(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static g(Landroid/content/Context;Ljava/lang/String;J)V
    ...
    invoke-static {p2}, Lh6/s;->k(Ljava/lang/String;)V

    const p2, 0x802c80

    invoke-static {p0, p2}, Lt5/o;->l(Landroid/content/Context;I)V

    new-instance p2, Landroid/os/Bundle;

    invoke-direct {p2}, Landroid/os/Bundle;-><init>()V

    invoke-static {p0, p2}, Lt5/o;->n(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    :try_start_0
    invoke-static {p3, v0}, Lt5/o;->j(Lcom/google/android/gms/tasks/Task;Ljava/lang/String;)Ljava/lang/Object;
    :try_end_0
    .catch Lf6/b; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p3, v0}, Lt5/o;->m(Lf6/b;Ljava/lang/String;)V

    :cond_0
    new-instance v3, Lt5/m;

    invoke-direct {v3, p1, p2}, Lt5/m;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V

    sget-object v2, Lt5/o;->c:Landroid/content/ComponentName;
    ...
    invoke-static/range {v1 .. v6}, Lt5/o;->i(Landroid/content/Context;Landroid/content/ComponentName;Lt5/n;JLjava/util/concurrent/Executor;)Ljava/lang/Object;
...
.method public static h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p0, v1, p1, v0, p2}, Lt5/o;->o(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;Landroid/app/PendingIntent;)V
...
.method public static i(Landroid/content/Context;Landroid/content/ComponentName;Lt5/n;JLjava/util/concurrent/Executor;)Ljava/lang/Object;
    .locals 1
    ...
    new-instance p5, Le6/a;

    invoke-direct {p5}, Le6/a;-><init>()V

    invoke-static {p0}, Lh6/i;->c(Landroid/content/Context;)Lh6/i;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p5, p4, v0}, Lh6/i;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;Ljava/util/concurrent/Executor;)Z
    ...
    :try_start_1
    invoke-virtual {p5}, Le6/a;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lt5/n;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p5, p4}, Lh6/i;->e(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method public static j(Lcom/google/android/gms/tasks/Task;Ljava/lang/String;)Ljava/lang/Object;
    ...
    sget-object v0, Lt5/o;->d:Lk6/a;

    new-array v1, v1, [Ljava/lang/Object;

    invoke-virtual {v0, p1, v1}, Lk6/a;->h(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static k(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1, v0}, Lk6/a;->h(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static l(Landroid/content/Context;I)V
    ...
    invoke-static {p0, p1}, Le6/j;->a(Landroid/content/Context;I)V
    :try_end_0
    .catch Le6/h; {:try_start_0 .. :try_end_0} :catch_2
    .catch Le6/g; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-direct {p1, v0, p0}, Lt5/d;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0}, Le6/n;->a()Landroid/content/Intent;

    move-result-object p0

    invoke-direct {p1, v0, v1, p0}, Lt5/f;-><init>(ILjava/lang/String;Landroid/content/Intent;)V

    throw p1
.end method

.method public static m(Lf6/b;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-virtual {v0, p0, v1}, Lk6/a;->h(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static n(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    sget-object v0, Lt5/o;->b:Ljava/lang/String;
...
.method public static o(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v1, v3, v6}, Lk6/a;->h(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p2}, Lt5/d;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p0}, Le6/f;->a(Landroid/content/Context;)I
    ...
    invoke-virtual {v1, p0, p4}, Lk6/a;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, p0, p1}, Lk6/a;->c(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static p(Landroid/accounts/Account;)V
    ...
    sget-object v0, Lt5/o;->a:[Ljava/lang/String;
...
.method public static q(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, p0, v1}, Le6/e;->h(Landroid/content/Context;I)I

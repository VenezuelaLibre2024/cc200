...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lg9/c;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2, p1, p3}, Lg9/c;->f(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/pm/PackageManager;)Landroid/content/Intent;
    ...
    invoke-static {p1}, Lg9/c;->q(Lcom/google/firebase/messaging/c;)Z
    ...
    :cond_1
    invoke-static {}, Lg9/c;->g()I

    move-result p1

    const/high16 p3, 0x40000000    # 2.0f

    invoke-static {p3}, Lg9/c;->l(I)I
...
.method public static b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2}, Lg9/c;->q(Lcom/google/firebase/messaging/c;)Z
    ...
    invoke-static {p0, p1, p2}, Lg9/c;->c(Landroid/content/Context;Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
...
.method public static d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/os/Bundle;)Lg9/c$a;
    .locals 5
    ...
    invoke-virtual {v3, p3}, Lx/l$e;->u(Ljava/lang/CharSequence;)Lx/l$e;
    ...
    invoke-virtual {v3, p3}, Lx/l$e;->t(Ljava/lang/CharSequence;)Lx/l$e;

    new-instance v4, Lx/l$c;

    invoke-direct {v4}, Lx/l$c;-><init>()V

    invoke-virtual {v4, p3}, Lx/l$c;->x(Ljava/lang/CharSequence;)Lx/l$c;

    move-result-object p3

    invoke-virtual {v3, p3}, Lx/l$e;->P(Lx/l$j;)Lx/l$e;
    ...
    invoke-static {v2, v1, v0, p3, p4}, Lg9/c;->m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I

    move-result p3

    invoke-virtual {v3, p3}, Lx/l$e;->N(I)Lx/l$e;

    invoke-static {v0, p2, v1}, Lg9/c;->n(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/res/Resources;)Landroid/net/Uri;

    move-result-object p3

    if-eqz p3, :cond_2

    invoke-virtual {v3, p3}, Lx/l$e;->O(Landroid/net/Uri;)Lx/l$e;

    :cond_2
    invoke-static {p0, p2, v0, v2}, Lg9/c;->a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;

    move-result-object p3

    invoke-virtual {v3, p3}, Lx/l$e;->s(Landroid/app/PendingIntent;)Lx/l$e;

    invoke-static {p0, p1, p2}, Lg9/c;->b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;

    move-result-object p0

    if-eqz p0, :cond_3

    invoke-virtual {v3, p0}, Lx/l$e;->w(Landroid/app/PendingIntent;)Lx/l$e;
    ...
    invoke-static {p1, p0, p4}, Lg9/c;->h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    invoke-virtual {v3, p0}, Lx/l$e;->m(Z)Lx/l$e;
    ...
    invoke-virtual {v3, p0}, Lx/l$e;->R(Ljava/lang/CharSequence;)Lx/l$e;
    ...
    invoke-virtual {v3, p0}, Lx/l$e;->I(I)Lx/l$e;
    ...
    invoke-virtual {v3, p0}, Lx/l$e;->V(I)Lx/l$e;
    ...
    invoke-virtual {v3, p0}, Lx/l$e;->F(I)Lx/l$e;
    ...
    invoke-virtual {v3, p1}, Lx/l$e;->L(Z)Lx/l$e;

    invoke-virtual {p0}, Ljava/lang/Long;->longValue()J

    move-result-wide p3

    invoke-virtual {v3, p3, p4}, Lx/l$e;->W(J)Lx/l$e;
    ...
    invoke-virtual {v3, p0}, Lx/l$e;->U([J)Lx/l$e;
    ...
    invoke-virtual {v3, p4, p1, p0}, Lx/l$e;->D(III)Lx/l$e;

    :cond_b
    invoke-static {p2}, Lg9/c;->i(Lcom/google/firebase/messaging/c;)I

    move-result p0

    invoke-virtual {v3, p0}, Lx/l$e;->v(I)Lx/l$e;

    new-instance p0, Lg9/c$a;

    invoke-static {p2}, Lg9/c;->o(Lcom/google/firebase/messaging/c;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, v3, p1, p3}, Lg9/c$a;-><init>(Lx/l$e;Ljava/lang/String;I)V

    return-object p0
.end method

.method public static e(Landroid/content/Context;Lcom/google/firebase/messaging/c;)Lg9/c$a;
    .locals 2
    ...
    invoke-static {v0, v1}, Lg9/c;->j(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-static {p0, v1, v0}, Lg9/c;->k(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0, p0, p1, v1, v0}, Lg9/c;->d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/os/Bundle;)Lg9/c$a;
...
.method public static g()I
    ...
    sget-object v0, Lg9/c;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    invoke-static {p1, v0}, Lg9/c;->p(Landroid/content/res/Resources;I)Z
    ...
    invoke-static {p1, p3}, Lg9/c;->p(Landroid/content/res/Resources;I)Z

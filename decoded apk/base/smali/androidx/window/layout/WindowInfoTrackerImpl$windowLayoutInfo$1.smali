...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/layout/WindowInfoTrackerImpl;->windowLayoutInfo(Landroid/app/Activity;)Lfe/b;
.end annotation
...
# direct methods
.method public constructor <init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Ljd/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static synthetic a(Lee/d;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invokeSuspend$lambda-0(Lee/d;Landroidx/window/layout/WindowLayoutInfo;)V

    return-void
.end method

.method private static final invokeSuspend$lambda-0(Lee/d;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lee/n;->c(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final create(Ljava/lang/Object;Ljd/d;)Ljd/d;
    ...
    invoke-direct {v0, v1, v2, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;-><init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Ljd/d;)V
...
.method public final invoke(Lfe/c;Ljd/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->create(Ljava/lang/Object;Ljd/d;)Ljd/d;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invoke(Lfe/c;Ljd/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v4, Lee/a;->i:Lee/a;

    const/4 v5, 0x4

    const/4 v6, 0x0

    invoke-static {v1, v4, v6, v5, v6}, Lee/f;->b(ILee/a;Lsd/l;ILjava/lang/Object;)Lee/d;

    move-result-object v1

    new-instance v4, Landroidx/window/layout/b;

    invoke-direct {v4, v1}, Landroidx/window/layout/b;-><init>(Lee/d;)V
    ...
    sget-object v7, Landroidx/window/layout/c;->h:Landroidx/window/layout/c;

    invoke-interface {v5, v6, v7, v4}, Landroidx/window/layout/WindowBackend;->registerLayoutChangeCallback(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lj0/a;)V

    :try_start_2
    invoke-interface {v1}, Lee/m;->iterator()Lee/e;
    ...
    invoke-interface {v1, v5}, Lee/e;->a(Ljd/d;)Ljava/lang/Object;
    ...
    invoke-interface {v1}, Lee/e;->next()Ljava/lang/Object;
    ...
    invoke-interface {v6, p1, v5}, Lfe/c;->emit(Ljava/lang/Object;Ljd/d;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v4}, Landroidx/window/layout/WindowBackend;->unregisterLayoutChangeCallback(Lj0/a;)V
    ...
    invoke-interface {v0, v4}, Landroidx/window/layout/WindowBackend;->unregisterLayoutChangeCallback(Lj0/a;)V

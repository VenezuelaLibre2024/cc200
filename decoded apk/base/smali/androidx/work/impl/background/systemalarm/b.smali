...
.method public constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/d;->f()Lo2/a;
    ...
    invoke-direct {p3, p1, p2, v0}, Lh2/d;-><init>(Landroid/content/Context;Lo2/a;Lh2/c;)V

    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/b;->d:Lh2/d;
...
.method public a()V
    ...
    invoke-interface {v0}, Ll2/q;->f()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/b;->d:Lh2/d;
    ...
    iget-object v5, v4, Ll2/p;->a:Ljava/lang/String;

    invoke-virtual {v4}, Ll2/p;->a()J
    ...
    invoke-virtual {v4}, Ll2/p;->b()Z

    move-result v6

    if-eqz v6, :cond_1

    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/b;->d:Lh2/d;

    invoke-virtual {v6, v5}, Lh2/d;->c(Ljava/lang/String;)Z
    ...
    iget-object v1, v1, Ll2/p;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v1, v5}, Lc2/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/b;->d:Lh2/d;

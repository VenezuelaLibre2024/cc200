...
.method public run()V
    ...
    invoke-virtual {v5, v6, v7, v2}, Lc2/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, v5, v0}, Lm2/d;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
    ...
    invoke-static {v0, v1, v3}, Lm2/d;->a(Landroid/content/Context;Ljava/lang/Class;Z)V

    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver$a;->i:Landroid/content/Context;

    const-class v1, Landroidx/work/impl/background/systemalarm/ConstraintProxy$NetworkStateProxy;

    invoke-static {v0, v1, v4}, Lm2/d;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
    :try_end_0

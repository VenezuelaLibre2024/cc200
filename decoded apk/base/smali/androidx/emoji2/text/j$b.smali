...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lh0/e;Landroidx/emoji2/text/j$a;)V
    .locals 1
    ...
    invoke-static {p2, v0}, Lj0/d;->k(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p2, p0, Landroidx/emoji2/text/j$b;->b:Lh0/e;
...
.method public c()V
    ...
    :try_start_1
    invoke-virtual {p0}, Landroidx/emoji2/text/j$b;->e()Lh0/g$b;

    move-result-object v0

    invoke-virtual {v0}, Lh0/g$b;->b()I
    ...
    invoke-static {v1}, Lg0/p;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/j$a;->a(Landroid/content/Context;Lh0/g$b;)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v0}, Lh0/g$b;->d()Landroid/net/Uri;

    move-result-object v0

    invoke-static {v2, v3, v0}, La0/l;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
...
.method public final e()Lh0/g$b;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/j$b;->b:Lh0/e;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/j$a;->b(Landroid/content/Context;Lh0/e;)Lh0/g$a;

    move-result-object v0
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0}, Lh0/g$a;->c()I

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Lh0/g$a;->b()[Lh0/g$b;

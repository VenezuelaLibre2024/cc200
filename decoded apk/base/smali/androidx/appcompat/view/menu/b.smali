...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->s:Ln/l0;
...
.method public final C()I
    ...
    invoke-static {v0}, Lk0/b0;->v(Landroid/view/View;)I
...
.method public final E(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/b;->y()Ln/m0;

    move-result-object v4

    invoke-virtual {v4, v1}, Ln/k0;->p(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Ln/k0;->A(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->u:I

    invoke-virtual {v4, v1}, Ln/k0;->B(I)V
    ...
    invoke-virtual {v4, v7}, Ln/m0;->P(Z)V

    invoke-virtual {v4, v5}, Ln/m0;->M(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Ln/k0;->y(Landroid/view/View;)V
    ...
    :goto_6
    invoke-virtual {v4, v12}, Ln/k0;->g(I)V

    invoke-virtual {v4, v3}, Ln/k0;->H(Z)V

    invoke-virtual {v4, v8}, Ln/k0;->l(I)V
    ...
    invoke-virtual {v4, v2}, Ln/k0;->g(I)V
    ...
    invoke-virtual {v4, v2}, Ln/k0;->l(I)V
    ...
    invoke-virtual {v4, v2}, Ln/k0;->C(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Ln/m0;Landroidx/appcompat/view/menu/e;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->p:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Ln/k0;->show()V

    invoke-virtual {v4}, Ln/k0;->j()Landroid/widget/ListView;
...
.method public a()Z
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Ln/m0;
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Ln/m0;

    invoke-virtual {v1, v2}, Ln/m0;->N(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Ln/m0;

    invoke-virtual {v1, v3}, Ln/k0;->z(I)V
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Ln/m0;

    invoke-virtual {v3}, Ln/k0;->a()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Ln/m0;

    invoke-virtual {v2}, Ln/k0;->dismiss()V
...
.method public o(Landroid/view/View;)V
    ...
    invoke-static {p1}, Lk0/b0;->v(Landroid/view/View;)I

    move-result p1

    invoke-static {v0, p1}, Lk0/e;->a(II)I
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Ln/m0;

    invoke-virtual {v4}, Ln/k0;->a()Z
...
.method public final y()Ln/m0;
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Ln/m0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->s:Ln/l0;

    invoke-virtual {v0, v1}, Ln/m0;->O(Ln/l0;)V

    invoke-virtual {v0, p0}, Ln/k0;->G(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Ln/k0;->F(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->v:Landroid/view/View;

    invoke-virtual {v0, v1}, Ln/k0;->y(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->u:I

    invoke-virtual {v0, v1}, Ln/k0;->B(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Ln/k0;->E(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Ln/k0;->D(I)V

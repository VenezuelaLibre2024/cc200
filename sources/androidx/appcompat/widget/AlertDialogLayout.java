...
public class AlertDialogLayout extends C0241c {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: j */
    private void m917j(int i10, int i11) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i12 = 0; i12 < i10; i12++) {
            View childAt = getChildAt(i12);
            if (childAt.getVisibility() != 8) {
                C0241c.a aVar = (C0241c.a) childAt.getLayoutParams();
    ...
    /* renamed from: y */
    private void m918y(View view, int i10, int i11, int i12, int i13) {
        view.layout(i10, i11, i12 + i10, i13 + i11);
    }

    /* renamed from: z */
    public static int m919z(View view) {
        int m12049w = C3308b0.m12049w(view);
        if (m12049w > 0) {
            return m12049w;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m919z(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: A */
    public final boolean m920A(int i10, int i11) {
        int i12;
        int i13;
        int i14;
        int i15;
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == C1936f.f7439P) {
                    view = childAt;
                } else if (id2 == C1936f.f7450k) {
                    view2 = childAt;
                } else {
                    if ((id2 != C1936f.f7452m && id2 != C1936f.f7454o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.c$a r15 = (androidx.appcompat.widget.C0241c.a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = p148k0.C3308b0.m12048v(r17)
            int r2 = p148k0.C3313e.m12211a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L95
            r3 = 5

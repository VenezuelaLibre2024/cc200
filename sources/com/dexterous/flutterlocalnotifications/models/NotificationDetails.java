...
public class NotificationDetails implements Serializable {
    ...
    /* renamed from: ID */
    private static final String f4163ID = "id";
    ...
    @InterfaceC4996c(alternate = {"allowWhileIdle"}, value = SCHEDULE_MODE)
    ...
    public static NotificationDetails from(Map<String, Object> map) {
        ...
        notificationDetails.f4164id = (Integer) map.get(f4163ID);

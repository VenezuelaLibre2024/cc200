...
public final class zzag extends AbstractC1164a {
    public final /* synthetic */ Account zza;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public zzag(zzal zzalVar, C1841a c1841a, AbstractC1846f abstractC1846f, Account account) {
    ...
    public final /* bridge */ /* synthetic */ void doExecute(C1841a.b bVar) {
        ((InterfaceC4899g) ((zzam) bVar).getService()).mo19463h0(new zzaf(this), this.zza);
    }

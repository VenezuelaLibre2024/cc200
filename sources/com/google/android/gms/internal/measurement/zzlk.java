...
public interface zzlk {
    ...
    <T> void zza(T t10, zzlj<T> zzljVar, zzis zzisVar);

    void zza(List<Boolean> list);

    @Deprecated
    <T> void zza(List<T> list, zzlj<T> zzljVar, zzis zzisVar);

    <K, V> void zza(Map<K, V> map, zzkm<K, V> zzkmVar, zzis zzisVar);

    float zzb();

    <T> void zzb(T t10, zzlj<T> zzljVar, zzis zzisVar);

    void zzb(List<zzhu> list);

    <T> void zzb(List<T> list, zzlj<T> zzljVar, zzis zzisVar);

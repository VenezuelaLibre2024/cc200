...
public final class zzw extends zzal {
    ...
    public final zzaq zza(zzh zzhVar, List<zzaq> list) {
        ...
        if (!zzapVar.zzc(ImagePickerCache.MAP_KEY_TYPE)) {
            throw new IllegalArgumentException("Undefined rule type");
        }
        this.zzk.zza(zzf, zzapVar.zzc("priority") ? zzg.zzb(zzapVar.zza("priority").zze().doubleValue()) : 1000, (zzar) zza, zzapVar.zza(ImagePickerCache.MAP_KEY_TYPE).zzf());
        return zzaq.zzc;
    }
}

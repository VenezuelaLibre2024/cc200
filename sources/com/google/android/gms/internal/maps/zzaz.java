...
public abstract class zzaz extends zzaw implements List, RandomAccess {
    ...
    public static zzaz zzg(Object[] objArr, int i10) {
        return i10 == 0 ? zzbc.zza : new zzbc(objArr, i10);
    }
    ...
    public zzaz subList(int i10, int i11) {
        zzas.zzc(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? zzbc.zza : new zzay(this, i10, i12);
    }

    @Override // java.util.List
    /* renamed from: zzh */
    public final zzbg listIterator(int i10) {
        zzas.zzb(i10, size(), "index");
        return isEmpty() ? zza : new zzax(this, i10);
    }
}

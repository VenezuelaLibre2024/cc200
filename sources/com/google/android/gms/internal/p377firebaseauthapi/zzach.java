...
public final class zzach {
    ...
    private static String zza(String str, Status status) {
        if (TextUtils.isEmpty(status.m4988K())) {
            return str;
        }
        return String.format(str + " [ %s ]", status.m4988K());
    }
    ...
    */
    public static p195n7.C3773m zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 552
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p377firebaseauthapi.zzach.zza(com.google.android.gms.common.api.Status):n7.m");
    }

    public static C3773m zza(Status status, AbstractC5368h abstractC5368h, String str, String str2) {
        int m4987J = status.m4987J();
        if (m4987J == 17012 || m4987J == 17007 || m4987J == 17025) {
            return new C5420x(zza(m4987J), zza(zzb(m4987J), status)).m21568e(abstractC5368h).m21567d(str).m21569f(str2);
        }
        return zza(status);
    }

    public static C5411u zza(FirebaseAuth firebaseAuth, zzyi zzyiVar, AbstractC5341a0 abstractC5341a0) {
        zzz.zza(firebaseAuth);
        zzz.zza(zzyiVar);
        Pair<String, String> pair = zza.get(17078);
        return new C5411u((String) pair.first, (String) pair.second, C5703o.m22790N(zzyiVar, firebaseAuth, abstractC5341a0));
    }

    public static boolean zza(Exception exc) {
        if (exc instanceof C5399q) {
            return ((C5399q) exc).m21548a().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C5399q) {
            return ((C5399q) exc).m21548a().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C5399q) {
            return ((C5399q) exc).m21548a().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
}

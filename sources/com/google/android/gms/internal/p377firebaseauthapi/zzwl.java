...
public final class zzwl {
    ...
    public final byte[] zza(byte[] bArr, String str, byte[] bArr2, byte[] bArr3, int i10, zzwp zzwpVar) {
        byte[] zza = zzwn.zza(this.zza, zzwn.zza(this.zza.getParams(), zzwpVar, bArr));
        int i11 = 1;
        byte[] zza2 = zzwi.zza(bArr, zza);

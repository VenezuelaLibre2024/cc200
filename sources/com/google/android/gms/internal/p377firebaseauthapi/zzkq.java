...
import com.google.android.gms.internal.p377firebaseauthapi.zzto;
...
public final class zzkq {
    ...
    private static zzvd zza(zztx zztxVar, zzuc zzucVar, zztj zztjVar, zzvd zzvdVar, zzvt zzvtVar, byte[] bArr) {
        zzto.zza zza2 = zzto.zza();
        zztw zztwVar = (zztw) ((zzaja) zztw.zza().zza(zztxVar).zza(zzucVar).zza(zzahm.zza(bArr)).zzf());
        return (zzvd) ((zzaja) zzvd.zza().zza(new zzje().zzd()).zza(zzvtVar).zza(((zzto) ((zzaja) zza2.zza((zztp) ((zzaja) zztp.zzc().zza(zztwVar).zza((zztk) ((zzaja) zztk.zza().zza(zzvdVar).zzf())).zza(zztjVar).zzf())).zzf())).zzi()).zzf());
    }
}

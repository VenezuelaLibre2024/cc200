...
public final class zzkz {
    ...
    public static zzkz zza(byte[] bArr, zzli zzliVar, zzlg zzlgVar, zzld zzldVar, zzla zzlaVar, byte[] bArr2) {
        ...
        byte[] zza5 = zzldVar.zza(zza2, bArr5, Constants.SECRET, zza3);
        byte[] zza6 = zzldVar.zza(zza5, zza4, io.flutter.plugins.firebase.crashlytics.Constants.KEY, zza3, zzlaVar.zza());

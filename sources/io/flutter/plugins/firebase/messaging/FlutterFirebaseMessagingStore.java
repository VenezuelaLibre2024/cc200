...
public class FlutterFirebaseMessagingStore {
    ...
    public void storeFirebaseMessage(C1287d c1287d) {
        setPreferencesStringValue(c1287d.m5511L(), new JSONObject(FlutterFirebaseMessagingUtils.remoteMessageToMap(c1287d)).toString());
        String str = getPreferencesStringValue(KEY_NOTIFICATION_IDS, "") + c1287d.m5511L() + ",";

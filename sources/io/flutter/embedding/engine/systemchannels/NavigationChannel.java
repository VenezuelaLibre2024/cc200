...
public class NavigationChannel {
    ...
    public void popRoute() {
        Log.m11045v(TAG, "Sending message to pop route.");
        this.channel.invokeMethod("popRoute", null);
    }

    public void pushRoute(String str) {
        Log.m11045v(TAG, "Sending message to push route '" + str + "'");
        this.channel.invokeMethod("pushRoute", str);
    }

    public void pushRouteInformation(String str) {
        Log.m11045v(TAG, "Sending message to push route information '" + str + "'");
    ...
    public void setInitialRoute(String str) {
        Log.m11045v(TAG, "Sending message to set initial route to '" + str + "'");

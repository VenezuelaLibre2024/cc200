...
public final class C5154a {
    ...
    public byte[] m20851a() {
        ...
        int m15038k = this.f19415a.m15038k();
        int m15041n = this.f19415a.m15041n();
        for (int i10 = 0; i10 < m15038k; i10++) {
            int[] iArr = f19414b[i10];
            for (int i11 = 0; i11 < m15041n; i11++) {
                int i12 = iArr[i11];
                if (i12 >= 0 && this.f19415a.m15035g(i11, i10)) {
                    int i13 = i12 / 6;

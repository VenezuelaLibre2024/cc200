...
public class C3622c extends AutoCompleteTextView implements InterfaceC3343z, InterfaceC3687n {

    /* renamed from: k */
    public static final int[] f12797k = {R.attr.popupBackground};

    /* renamed from: h */
    public final C3625d f12798h;

    /* renamed from: i */
    public final C3620b0 f12799i;

    /* renamed from: j */
    public final C3644l f12800j;

    public C3622c(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1931a.f7344p);
    }

    public C3622c(Context context, AttributeSet attributeSet, int i10) {
        super(C3661t0.m13708b(context), attributeSet, i10);
        C3657r0.m13693a(this, getContext());
        C3667w0 m13717u = C3667w0.m13717u(getContext(), attributeSet, f12797k, i10, 0);
    ...
    /* renamed from: a */
    public void m13444a(C3644l c3644l) {
    ...
    public void drawableStateChanged() {
        ...
        C3625d c3625d = this.f12798h;
        if (c3625d != null) {
            c3625d.m13452b();
        }
        C3620b0 c3620b0 = this.f12799i;
        if (c3620b0 != null) {
            c3620b0.m13397b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f12799i.m13404j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f12799i.m13405k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f12800j.m13606d(C3648n.m13620a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z10) {
        this.f12800j.m13607e(z10);
    }

    @Override // android.widget.TextView
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f12800j.m13603a(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f12799i.m13417w(colorStateList);
        this.f12799i.m13397b();
    }

    @Override // p188n0.InterfaceC3687n
    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f12799i.m13418x(mode);
        this.f12799i.m13397b();
    }

...
public class C3662u extends RadioButton implements InterfaceC3686m, InterfaceC3343z, InterfaceC3687n {

    /* renamed from: h */
    public final C3638i f13035h;

    /* renamed from: i */
    public final C3625d f13036i;

    /* renamed from: j */
    public final C3620b0 f13037j;

    /* renamed from: k */
    public C3646m f13038k;

    public C3662u(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1931a.f7321F);
    }

    public C3662u(Context context, AttributeSet attributeSet, int i10) {
    ...
    public void drawableStateChanged() {
        ...
        C3625d c3625d = this.f13036i;
        if (c3625d != null) {
            c3625d.m13452b();
        }
        C3620b0 c3620b0 = this.f13037j;
        if (c3620b0 != null) {
            c3620b0.m13397b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f13037j.m13404j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f13037j.m13405k();
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f13037j.m13417w(colorStateList);
        this.f13037j.m13397b();
    }

    @Override // p188n0.InterfaceC3687n
    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f13037j.m13418x(mode);
        this.f13037j.m13397b();
    }
}

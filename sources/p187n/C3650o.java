...
public class C3650o extends ImageButton implements InterfaceC3343z, InterfaceC3688o {

    /* renamed from: h */
    public final C3625d f12973h;

    /* renamed from: i */
    public final C3652p f12974i;

    /* renamed from: j */
    public boolean f12975j;

    public C3650o(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1931a.f7318C);
    }

    public C3650o(Context context, AttributeSet attributeSet, int i10) {
    ...
    public void drawableStateChanged() {
        ...
        C3625d c3625d = this.f12973h;
        if (c3625d != null) {
            c3625d.m13452b();
        }
        C3652p c3652p = this.f12974i;
        if (c3652p != null) {
            c3652p.m13652c();
        }
    }
    ...
    public boolean hasOverlappingRendering() {
        return this.f12974i.m13655f() && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C3652p c3652p = this.f12974i;
        if (c3652p != null && drawable != null && !this.f12975j) {
            c3652p.m13657h(drawable);
        }
        super.setImageDrawable(drawable);
        C3652p c3652p2 = this.f12974i;
        if (c3652p2 != null) {
            c3652p2.m13652c();
            if (this.f12975j) {
                return;
            }
            this.f12974i.m13651b();
        }
    }

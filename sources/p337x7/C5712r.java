...
public final class C5712r {
    /* renamed from: a */
    public static Status m22812a(String str) {
        ...
        return asList.size() > 1 ? m22813b((String) asList.get(0), (String) asList.get(1)) : m22813b((String) asList.get(0), null);
    }

    /* renamed from: b */
    public static Status m22813b(String str, String str2) {
        int i10;
        str.hashCode();
        char c10 = 65535;
        switch (str.hashCode()) {
